...
static Opcode opcodes[256]= {
    ...
    [0x46] = {"LD B, (HL)", 1, &ld_b_m},
    [0x4E] = {"LD C, (HL)", 1, &ld_c_m},
    ...
    [0x46] = {"LD D, (HL)", 1, &ld_d_m},
    [0x4E] = {"LD E, (HL)", 1, &ld_e_m},
    ...
    [0x66] = {"LD H, (HL)", 1, &ld_h_m},
    [0x6E] = {"LD L, (HL)", 1, &ld_l_m},

    [0x70] = {"LD (HL), B", 1, &ld_m_b},
    [0x71] = {"LD (HL), C", 1, &ld_m_c},
    [0x72] = {"LD (HL), D", 1, &ld_m_d},
    [0x73] = {"LD (HL), E", 1, &ld_m_e},
    [0x74] = {"LD (HL), H", 1, &ld_m_h},
    [0x75] = {"LD (HL), L", 1, &ld_m_l},
    [0x77] = {"LD (HL), A", 1, &ld_m_a},
